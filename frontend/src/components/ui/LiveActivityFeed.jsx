...
const POOL = [
  ...
  { type:'earn',       name:'F. Diallo',    amount:30.00, plan:'Performance'},
  { type:'deposit',    name:'I. Touré',     amount:1000,  crypto:'usdt'     },
  { type:'withdraw',   name:'A. Koné',      amount:315,   crypto:'ethereum' },
  { type:'earn',       name:'S. Ndiaye',    amount:80.00, plan:'Patrimoine' },
  { type:'deposit',    name:'M. Bah',       amount:250,   crypto:'bnb'      },
  { type:'earn',       name:'C. Ouedraogo', amount:3.00,  plan:'Découverte' },
  { type:'deposit',    name:'J. Eze',       amount:5000,  crypto:'bitcoin'  },
  { type:'earn',       name:'A. Traoré',    amount:11.25, plan:'Standard'   },
  { type:'withdraw',   name:'O. Diop',      amount:200,   crypto:'usdt'     },
  { type:'deposit',    name:'B. Sawadogo',  amount:500,   crypto:'ethereum' },
  { type:'earn',       name:'R. Fofana',    amount:250,   plan:'VIP Exec'   },
  { type:'deposit',    name:'L. Gbagbo',    amount:1000,  crypto:'usdt'     },
  { type:'withdraw',   name:'P. Coulibaly', amount:100,   crypto:'bnb'      },
  { type:'earn',       name:'D. Camara',    amount:30.00, plan:'Performance'},
  { type:'deposit',    name:'E. Asante',    amount:2500,  crypto:'bitcoin'  },
  { type:'earn',       name:'N. Keita',     amount:3.00,  plan:'Découverte' },
  { type:'withdraw',   name:'T. Manga',     amount:600,   crypto:'ethereum' },
  { type:'deposit',    name:'Y. Oumar',     amount:5000,  crypto:'usdt'     },
  { type:'earn',       name:'G. Mensah',    amount:600,   plan:'Club Privé' },
]
