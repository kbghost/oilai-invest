...
const POOL = [
  { type:'deposit',    name:'A. Morgan',    amount:500,   crypto:'bitcoin'  },
  { type:'earn',       name:'S. Jenkins',   amount:30.00, plan:'Performance'},
  { type:'deposit',    name:'D. Schmidt',   amount:1000,  crypto:'usdt'     },
  { type:'withdraw',   name:'E. Rostova',   amount:315,   crypto:'ethereum' },
  { type:'earn',       name:'C. Rodriguez', amount:80.00, plan:'Patrimoine' },
  { type:'deposit',    name:'L. Wei',       amount:250,   crypto:'bnb'      },
  { type:'earn',       name:'J. Dupont',    amount:3.00,  plan:'Découverte' },
  { type:'deposit',    name:'T. Tanaka',    amount:5000,  crypto:'bitcoin'  },
  { type:'earn',       name:'H. Weber',     amount:11.25, plan:'Standard'   },
  { type:'withdraw',   name:'M. Al-Mansoor',amount:200,   crypto:'usdt'     },
  { type:'deposit',    name:'K. Mensah',    amount:500,   crypto:'ethereum' },
  { type:'earn',       name:'V. Rossi',     amount:250,   plan:'VIP Exec'   },
  { type:'deposit',    name:'B. Smith',     amount:1000,  crypto:'usdt'     },
  { type:'withdraw',   name:'S. Kim',       amount:100,   crypto:'bnb'      },
  { type:'earn',       name:'A. Silva',     amount:30.00, plan:'Performance'},
  { type:'deposit',    name:'N. Patel',     amount:2500,  crypto:'bitcoin'  },
  { type:'earn',       name:'R. Kowalski',  amount:3.00,  plan:'Découverte' },
  { type:'withdraw',   name:'O. Diop',      amount:600,   crypto:'ethereum' },
  { type:'deposit',    name:'F. Garcia',    amount:5000,  crypto:'usdt'     },
  { type:'earn',       name:'P. Dubois',    amount:600,   plan:'Club Privé' },
]
