...
{[['#plans','Plans'],['#calcul','Calcul'],['#paiements','Paiement']].map(([h,l]) => (
          ...
          <ThemeToggle compact />
          <Link to="/login" style={{ padding:'0.45rem 0.75rem',borderRadius:9,fontSize:12,fontWeight:600,color:'var(--text-secondary)',textDecoration:'none',border:'1px solid var(--border)',background:'var(--bg-card2)' }}>Connexion</Link>
          <Link to="/register" className="btn-primary" style={{ padding:'0.45rem 0.875rem',fontSize:12 }}>Commencer</Link>
        </div>
      </nav>
